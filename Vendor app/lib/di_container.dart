...
import 'package:sixvalley_vendor_app/features/auction/domain/repository/auction_ai_repository.dart';
import 'package:sixvalley_vendor_app/features/auction/domain/repository/auction_ai_repository_interface.dart';
import 'package:sixvalley_vendor_app/features/auction/domain/services/auction_ai_service.dart';
import 'package:sixvalley_vendor_app/features/auction/domain/services/auction_ai_service_interface.dart';
import 'package:sixvalley_vendor_app/features/auction/domain/repository/auction_product_repository.dart';
import 'package:sixvalley_vendor_app/features/auction/domain/repository/auction_product_repository_interface.dart';
import 'package:sixvalley_vendor_app/features/auction/domain/services/auction_product_service.dart';
...
import 'features/auction/controllers/add_auction_product_contoller.dart';
import 'features/auction/controllers/add_auction_product_media_controller.dart';
import 'features/auction/domain/repository/add_auction_product_repository.dart';
import 'features/auction/domain/repository/add_auction_product_repository_interface.dart';
import 'features/auction/domain/services/add_auction_product_service.dart';
import 'features/auction/domain/services/add_auction_product_service_interface.dart';
import 'features/auction/controllers/auction_transaction_controller.dart';
import 'features/auction/domain/repository/auction_transaction_repository.dart';
import 'features/auction/domain/repository/auction_transaction_repository_interface.dart';
import 'features/third_party_deliveryman/controllers/third_party_deliveryman_controller.dart';
import 'features/third_party_deliveryman/domain/repositories/third_party_deliveryman_repository.dart';
import 'features/third_party_deliveryman/domain/repositories/third_party_deliveryman_repository_interface.dart';
import 'features/third_party_deliveryman/domain/services/third_party_deliveryman_service.dart';
import 'features/third_party_deliveryman/domain/services/third_party_deliveryman_service_interface.dart';
import 'features/auction/domain/services/auction_transaction_service.dart';
import 'features/auction/domain/services/auction_transaction_service_interface.dart';
...
Future<void> init() async {
  ...
  AuctionAiRepositoryInterface auctionAiRepositoryInterface = AuctionAiRepository(dioClient: sl());
  sl.registerLazySingleton(() => auctionAiRepositoryInterface);
  AuctionProductRepositoryInterface auctionProductRepositoryInterface = AuctionProductRepository(dioClient: sl());
  ...
  AuctionAiServiceInterface auctionAiServiceInterface = AuctionAiService(auctionAiRepositoryInterface: sl());
  sl.registerLazySingleton(() => auctionAiServiceInterface);
  AuctionProductServiceInterface auctionProductServiceInterface = AuctionProductService(auctionProductRepoInterface: sl());
  ...
  sl.registerLazySingleton(() => AuctionAiRepository(dioClient: sl()));
  sl.registerLazySingleton(() => AuctionProductRepository(dioClient: sl()));
  ...
  sl.registerFactory(() => AuctionProductController(auctionProductServiceInterface: sl()));
  sl.registerFactory(() => AddAuctionProductController(addAuctionProductServiceInterface : sl()));

  AuctionTransactionRepositoryInterface auctionTransactionRepo = AuctionTransactionRepository(dioClient: sl());
  sl.registerLazySingleton(() => auctionTransactionRepo);
  AuctionTransactionServiceInterface auctionTransactionService = AuctionTransactionService(repositoryInterface: sl());
  sl.registerLazySingleton(() => auctionTransactionService);
  sl.registerFactory(() => AuctionTransactionController(serviceInterface: sl()));

  ThirdPartyDeliverymanRepositoryInterface thirdPartyDeliverymanRepo = ThirdPartyDeliverymanRepository(dioClient: sl());
  sl.registerLazySingleton(() => thirdPartyDeliverymanRepo);
  ThirdPartyDeliverymanServiceInterface thirdPartyDeliverymanService = ThirdPartyDeliverymanService(repositoryInterface: sl());
  sl.registerLazySingleton(() => thirdPartyDeliverymanService);
  sl.registerFactory(() => ThirdPartyDeliverymanController(serviceInterface: sl()));
}

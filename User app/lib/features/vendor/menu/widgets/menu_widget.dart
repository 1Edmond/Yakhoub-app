...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/addProduct/screens/add_product_tab_view_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/auction/screens/auction_menu_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/clearance_sale/screens/clearance_sale_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/restock/screens/restock_list_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/splash/domain/models/business_pages_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/splash/domain/models/config_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/vat_management/screens/vat_management_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/localization/language_constrants.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/profile/controllers/profile_controller.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/vendor/utill/app_constants.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/vendor/common/basewidgets/custom_bottom_sheet_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/chat/screens/inbox_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/coupon/screens/coupon_list_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/dashboard/screens/nav_bar_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/delivery_man/screens/delivery_man_setup_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/menu/widgets/sign_out_confirmation_dialog_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/more/screens/html_view_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product/screens/product_list_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/profile/screens/profile_view_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/review/screens/product_review_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/settings/screens/setting_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/shop/screens/shop_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/wallet/screens/wallet_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/bank_info/screens/bank_info_screen.dart';
    ...
    return Consumer<SplashController>(
      builder: (context, splashController, _) {
        ...
        List<CustomBottomSheetWidget> activateMenu = [
          ...
          if (configModel?.isAuctionFeatureEnabled == true || Provider.of<ProfileController>(context, listen: false).userInfoModel?.showAuctionMenuForVendor == true)
          CustomBottomSheetWidget(image: Images.auctionMenuIcon, title: getTranslated('auctions', context),
            onTap: () => _handleMenuTap(context, const AuctionMenuScreen()),
          ),

                  ...
                  aiController.titleSuggestionModel?.data?.titles != null && aiController.titleSuggestionModel!.data!.titles!.isNotEmpty ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        child: ListTile(
                          title: Text(aiController.titleSuggestionModel?.data?.titles?[index] ?? '', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge?.color)),
                          trailing: InkWell(
                            onTap: () async {

...
class AiService implements AiServiceInterface {
  ...
  @override
  Future<dynamic> generateAuctionTitle({required String title, required String langCode}) async {
    return await aiRepositoryInterface.generateAuctionTitle(title: title, langCode: langCode);
  }

  @override
  Future<dynamic> generateAuctionDescription({required String title, required String langCode}) async {
    return await aiRepositoryInterface.generateAuctionDescription(title: title, langCode: langCode);
  }

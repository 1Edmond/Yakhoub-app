...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/ai/domain/repositories/ai_repository_interface.dart';
...
class AiRepository implements AiRepositoryInterface {
  ...
  @override
  Future<ApiResponse?> generateAuctionTitle({required String title, required String langCode}) async {
    try {
      final response = await dioClient?.post(
  ...
  @override
  Future<ApiResponse?> generateAuctionDescription({required String title, required String langCode}) async {
    try {
      final response = await dioClient?.post(

...
class ProfileInfoModel {
  ...
  double? auctionTotalEarning;
  double? auctionTotalVat;
  double? auctionTotalShipping;
  double? auctionWithdrawableBalance;
  double? auctionPendingWithdraw;
  double? auctionTotalCommissionGiven;
  double? auctionPendingCommission;
  double? auctionTotalPendingAmount;
  bool? auctionWalletVisible;
  bool? showAuctionMenuForVendor;
  ...
  ProfileInfoModel(
      {this.id,
        ...
        this.auctionTotalEarning,
        this.auctionTotalVat,
        this.auctionTotalShipping,
        this.auctionWithdrawableBalance,
        this.auctionPendingWithdraw,
        this.auctionTotalCommissionGiven,
        this.auctionPendingCommission,
        this.auctionTotalPendingAmount,
        this.auctionWalletVisible,
        this.showAuctionMenuForVendor,
      });
  ...
  ProfileInfoModel.fromJson(Map<String, dynamic> json) {
    ...
    auctionTotalEarning = json['auction_total_earning'] != null
        ? (json['auction_total_earning']).toDouble() : null;
    auctionTotalVat = json['auction_total_vat'] != null
        ? (json['auction_total_vat']).toDouble() : null;
    auctionTotalShipping = json['auction_total_shipping'] != null
        ? (json['auction_total_shipping']).toDouble() : null;
    auctionWithdrawableBalance = json['auction_withdrawable_balance'] != null
        ? (json['auction_withdrawable_balance']).toDouble() : null;
    auctionPendingWithdraw = json['auction_pending_withdraw'] != null
        ? (json['auction_pending_withdraw']).toDouble() : null;
    auctionTotalCommissionGiven = json['auction_total_commission_given'] != null
        ? (json['auction_total_commission_given']).toDouble() : null;
    auctionPendingCommission = json['auction_pending_commission'] != null
        ? (json['auction_pending_commission']).toDouble() : null;
    auctionTotalPendingAmount = json['auction_total_pending_amount'] != null
        ? (json['auction_total_pending_amount']).toDouble() : null;
    auctionWalletVisible = json['auction_wallet_visible'];
    showAuctionMenuForVendor = json['show_auction_menu_for_vendor'] == '1' || json['show_auction_menu_for_vendor'] == 1 || json['show_auction_menu_for_vendor'] == true;

...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/clearance_sale/domain/models/chearance_slale_add_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/clearance_sale/domain/models/clearance_config_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/clearance_sale/domain/models/clearnace_sale_product_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/clearance_sale/domain/services/clearance_sale_service_interface.dart';
...
class ClearanceSaleController extends ChangeNotifier {
  ...
  void selectDate(String type, BuildContext context) async {
    ...
    final DateTime firstDate = isEnd && _startDate != null
    ...
    final DateTime initialDate = isEnd && _startDate != null
        ...
        : (type == 'start' && _startDate != null ? _startDate! : now);

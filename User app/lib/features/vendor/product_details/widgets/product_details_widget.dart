...
import 'package:flutter_sixvalley_ecommerce/features/vendor/data/model/image_full_url.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product_details/controllers/product_details_controller.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product_details/enums/preview_type.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product_details/widgets/audio_preview.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product_details/widgets/download_preview_file.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product_details/widgets/image_preview.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product_details/widgets/pdf_preview_flutter.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product_details/widgets/video_preview.dart';
...
class _ProductDetailsWidgetState extends State<ProductDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    String buildVatText() {
      final vats = (widget.productModel?.taxVats ?? []).where((vat) => (vat.tax?.taxRate ?? 0) > 0).toList();
      String result = '';
          ...
          Column(children: [
            Stack(
              children:[Container(
                ...
                if((productModel?.clearanceSale?.discountAmount ?? 0) > 0)
                  Positioned(top: 0, left: 0,
                    child: const DiscountTagWidget(),
                  ),
              ]
            ),
            const SizedBox(height: Dimensions.paddingSizeSmall),

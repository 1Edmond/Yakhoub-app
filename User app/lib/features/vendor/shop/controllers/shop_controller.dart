...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/clearance_sale/widgets/show_custom_time_picker.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/product/controllers/product_controller.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/shop/domain/models/payment_information_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/shop/domain/models/shop_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/shop/domain/models/vacation_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/shop/domain/models/withdrawal_method_model.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/shop/domain/services/shop_service_interface.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/splash/controllers/splash_controller.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/splash/domain/models/config_model.dart' hide Data;
...
class ShopController extends ChangeNotifier {
  ...
  void selectDateTime(String type, bool is24Hour,BuildContext context, {DateTime? dateTime}) async {
    ...
    final DateTime firstDate = isEnd && _startDateTime != null
        ? DateTime(_startDateTime!.year, _startDateTime!.month, _startDateTime!.day)
        : today;
    final DateTime initialDate = isEnd && _startDateTime != null
        ? (_endDateTime != null && !_endDateTime!.isBefore(_startDateTime!) ? _endDateTime! : _startDateTime!)
        : (dateTime ?? (type == 'start' && _startDateTime != null ? _startDateTime! : now));
    ...
    showDatePicker(
      ...
      time = await showCustomTimePicker(dateTime: dateTime);
      if (time == null) return;
      ...
      if (type == 'start') {
        ...
        if (_endDateTime != null && !_endDateTime!.isAfter(_startDateTime!)) {
          _endDateTime = null;
          _vacationModel?.vacationEndDate = null;
        }
      } else {

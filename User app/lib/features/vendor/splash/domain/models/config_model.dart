...
class ConfigModel {
  ...
  bool? activeAuctionForVendor;
  bool? deliveryPartnerSetupStatus;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    activeAuctionForVendor = json['active_auction_for_vendor'] == '1' || json['active_auction_for_vendor'] == 1 || json['active_auction_for_vendor'] == true;
    deliveryPartnerSetupStatus = json['vendor_delivery_partner_setup_status'] == '1' || json['vendor_delivery_partner_setup_status'] == 1 || json['vendor_delivery_partner_setup_status'] == true;

...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/coupon/domain/services/coupon_service_interface.dart';
...
class CouponController with ChangeNotifier {
  ...
  void selectDate(String type, BuildContext context){
    ...
    final DateTime firstDate = isEnd && startDate != null ? startDate! : DateTime(2022);
    final DateTime initialDate = isEnd && startDate != null
        ? (endDate != null && !endDate!.isBefore(startDate!) ? endDate! : startDate!)
        : (type == 'start' && startDate != null ? startDate! : DateTime.now());

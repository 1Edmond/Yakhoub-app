...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/delivery_man/widgets/order_change_log_widget.dart';
                          ...
                          child: Row(
                            children: [
                              Text('${getTranslated('order_no', context)}# ',
                                style: titilliumSemiBold.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeLarge),),

...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/delivery_man/screens/top_delivery_man_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/delivery_man/widgets/top_delivery_man_widget.dart';
          ...
          Padding(
            ...
            child: GridView.builder(
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                mainAxisSpacing: 9,
                crossAxisSpacing: 5,
                childAspectRatio: MediaQuery.of(context).size.width < 400? 1/1.15 : MediaQuery.of(context).size.width < 415? 1/1.23: 1/1.35,
              ),
              ...
              itemBuilder: (context, index) {
                return ColoredBox(
                  ...
                  child: TopDeliveryManWidget(deliveryMan : deliveryManList![index]));
              },
            ),

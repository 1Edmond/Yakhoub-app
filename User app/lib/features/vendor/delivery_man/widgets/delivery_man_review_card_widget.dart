          ...
          Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeExtraSmall,
                ...
                child: Row(children: [
                  Text('${getTranslated('order_id', context)}# ', style: robotoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
                  Text(reviewModel.orderId.toString(), style: robotoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color))]
                ))
            ])),
          ],
          ),

            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    flex: 2,
                    child: Text(getTranslated('category_wise_filter', context)!, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color))
                  ),
                    ...
                    child: Consumer<ProductController>(
                      builder: (context, productProvider, _) {
                        return Row(
                          ...
                          children: [
                            if(productProvider.isFilterApplied)
                            InkWell(
                              onTap: () {
                                Navigator.pop(context);
                                productProvider.isFilterReset(false);
                                productProvider.getPosProductList(1, context, []);

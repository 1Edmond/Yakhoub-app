...
import 'package:flutter_sixvalley_ecommerce/features/vendor/common/basewidgets/rating_bar_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(
        title : getTranslated('review_reply', context), isAction: true, isSwitch: true,
        index: widget.index,

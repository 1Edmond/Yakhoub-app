...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/language/screens/change_language_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/settings/widgets/choose_shipping_dialog_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/third_party_deliveryman/screens/third_party_delivery_partner_screen.dart';
    ...
    return Scaffold(
      ...
      body: ListView(physics: const BouncingScrollPhysics(), children: [
          ...
          TitleButton(
            ...
            onTap: ()=> Navigator.of(context).push(MaterialPageRoute(builder: (_) => const ThirdPartyDeliveryPartnerScreen())),
          ),

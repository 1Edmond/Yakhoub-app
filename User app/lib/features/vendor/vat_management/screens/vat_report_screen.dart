...
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/vat_management/controllers/vat_controller.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/vat_management/widgets/order_info_card_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/vat_management/widgets/order_list_card_shimmer_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/vat_management/widgets/order_list_card_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/vat_management/widgets/tax_info_card.dart';
import 'package:flutter_sixvalley_ecommerce/features/vendor/features/vat_management/widgets/vat_filter_bottomsheet.dart';
...
class _VatReportScreenState extends State<VatReportScreen> {
  ...
  void initState() {
    ...
    vatController.setInitialDateRange();
    vatController.getVatReportList(1, startDate: vatController.startDate.toString(), endDate: vatController.endDate.toString());
  }
      ...
      appBar: CustomAppBarWidget(title: getTranslated('vat_report', context),
         ...
         widget: Consumer<VatController>(
           builder: (context, vatController, child) {
             return (vatController.vatReportModel?.typeWiseTaxesList != null &&  vatController.vatReportModel!.typeWiseTaxesList!.isNotEmpty || (vatController.vatReportModel?.typeWiseTaxesList != null &&  vatController.vatReportModel!.typeWiseTaxesList!.isEmpty)) ? InkWell(
              onTap: () {

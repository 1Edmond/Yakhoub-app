...
import 'package:flutter_sixvalley_ecommerce/common/vendor/features/addProduct/controllers/variation_controller.dart';
import 'package:flutter_sixvalley_ecommerce/common/vendor/features/addProduct/widgets/add_product_section_widget.dart';
...
import 'package:flutter_sixvalley_ecommerce/common/vendor/features/addProduct/controllers/add_product_controller.dart';
                    ...
                    return variationController.attributeList!.asMap().entries.map((entry) {
                      ...
                      return PopupMenuItem<int>(
                        ...
                        child: Row(
                          children: [
                            Text(
                              attributeModel.attribute.name!.substring(0, 1).toUpperCase() + attributeModel.attribute.name!.substring(1),
                              style: robotoRegular.copyWith(
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(
                        '${variationController.attributeList![index].attribute.name!.substring(0, 1).toUpperCase()}${variationController.attributeList![index].attribute.name!.substring(1)} ${getTranslated('attribute', context)}', maxLines: 2, textAlign: TextAlign.center,

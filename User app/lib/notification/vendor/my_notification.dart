...
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/auth/controllers/auth_controller.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/auth/screens/login_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/dashboard/screens/dashboard_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/maintenance/maintenance_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/product/screens/product_list_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/refund/domain/models/refund_model.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/refund/screens/refund_details_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/splash/controllers/splash_controller.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/splash/domain/models/config_model.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/wallet/screens/wallet_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/notification/models/notification_body.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/utill/app_constants.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/chat/screens/inbox_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/notification/screens/notification_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/auction/controllers/auction_product_controller.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/auction/screens/auction_details_screen.dart';
import 'package:flutter_sixvalley_ecommerce/notification/vendor/features/order_details/screens/order_details_screen.dart';
...
class MyNotification {
  ...
  static Future<void> initialize(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    ...
    flutterLocalNotificationsPlugin.initialize(settings: initializationsSettings, onDidReceiveNotificationResponse: (NotificationResponse data) async {
      ...
      try{
        ...
        if(data.payload != null && data.payload!.isNotEmpty) {
          ...
          } else if(payload.type?.startsWith('auction') == true && payload.auctionId != null){
            Get.navigator!.push(MaterialPageRoute(builder: (context) => AuctionDetailsScreen(fromNotification: false, auctionId: payload.auctionId!)));
          }
        }
      } catch (e) {
        if (kDebugMode) {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      debugPrint("onMessageOutDebugPrint: ${message.toMap()}");
      if (kDebugMode) {
      ...
      if(message.data['type'] != 'maintenance_mode') {
        if (message.data['type'] == 'auction_new_bid') {
          debugPrint('IS_AUCTION_NEW_BID ${message.data}');
          final NotificationBody body = NotificationBody.fromJson(message.data);
          if (body.auctionId != null && AuctionDetailsScreen.activeAuctionId == body.auctionId && Get.context != null) {
            Provider.of<AuctionProductController>(Get.context!, listen: false).getBidList(body.auctionId!, 1);
          } else {
